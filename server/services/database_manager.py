...
class DatabaseManager:
    ...
    async def create_user_profile(self, user_id: str, email: str, username: str = None, full_name: str = None):
    ...
    async def save_dataset_metadata(self, user_id: str, file_name: str, original_file_name: str, 
                                   file_path: str, file_size: int, row_count: int, 
                                   column_count: int, columns: List[str], dtypes: Dict):
    ...
    async def delete_dataset(self, dataset_id: str, user_id: str):
        ...
        try:
            ...
            self.client.table("datasets").delete().eq("id", dataset_id).eq("user_id", user_id).execute()
            return True
        except Exception as e:
    ...
    async def save_dashboard(self, user_id: str, dataset_id: str, title: str, 
                            dashboard_type: str, html_content: str, 
                            charts_config: Dict = None, ai_insights: Dict = None):
    ...
    async def delete_dashboard(self, dashboard_id: str, user_id: str):
        ...
        try:
            ...
            self.client.table("dashboards").delete().eq("id", dashboard_id).eq("user_id", user_id).execute()
            return True
        except Exception as e:
    ...
    async def save_analysis_result(self, user_id: str, dataset_id: str, analysis_type: str,
                                  parameters: Dict, results: Dict, charts: Dict = None):
    ...
    async def get_analysis_history(self, dataset_id: str, limit: int = 50, offset: int = 0):
